  ...
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <div class="login-container">
        ...
        <h5 style="text-align: center;">Pour commencer, veuillez vous connecter</h5>
        ...
        <!-- Boutons -->
        <ion-button expand="block" @click="handleSignIn" class="ion-margin-top">
          Se connecter
        </ion-button>
        ...
        <br><br>
        <ion-item>
            <ion-label>Vous n'avez pas encore de compte?</ion-label>
